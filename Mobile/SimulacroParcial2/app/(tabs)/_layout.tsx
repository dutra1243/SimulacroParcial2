...
export default function RootLayout() {
    return (
        <Tabs>
            <Tabs.Screen name="index" options={{ title: "Home", headerTitleAlign: "center", tabBarIcon: ({ focused }) => (<MaterialCommunityIcons name={"airplane"} color={focused ? "blue" : "grey"} size={25} ></MaterialCommunityIcons>) }} />
